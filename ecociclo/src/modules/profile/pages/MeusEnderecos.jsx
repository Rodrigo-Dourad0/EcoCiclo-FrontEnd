        ...
        <section className="me-content">
          ...
          {enderecos.length === 0 ? (
            ...
            <div className="me-lista">
              {enderecos.map((end) => (
                <div key={end.id} className={`me-card ${end.principal ? "me-card--principal" : ""}`}>
                  <div className="me-card-topo">
                    ...
                    <div className="me-card-info">
                      <p className="me-card-rua">
                        {end.rua}, {end.numero}
                        {end.principal && <span className="me-badge">Principal</span>}
                      </p>
                      {end.complemento && (
                      ...
                      <p className="me-card-detalhe">CEP: {end.cep}</p>
                    </div>
                  </div>
                  ...
                  <div className="me-card-acoes">
                    ...
                    <button
                      className="me-btn-editar"
                      onClick={() => handleEditar(end.id)}
                    >
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
